...
const categories = [
  ...
  },
  {
    ...
    articles: [
      ...
      "Setting up Inventory (10 min)",
      "Managing Staff (8 min)",
        ...
        <RevealOnScroll>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Find answers, tutorials, and guides to help you get the most out of BusinessOS.
            </p>
                  ...
                  <ul className="space-y-2">
                    {category.articles.map((article) => (
                      <li key={article}>
                        <Link
                          href="#"
                          className="flex items-center justify-between text-gray-400 hover:text-white transition-colors py-2"
                        >
                          <span>{article}</span>
        ...
        <RevealOnScroll delay={500}>
          <div className="bg-[#0a0a0a] border border-gray-800 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="mailto:support@rinads.com"
                className="px-6 py-3 bg-white/5 hover:bg-white/10 border border-gray-700 text-white rounded-lg font-medium transition-all"
              >
                Email Us
              </Link>
            </div>
